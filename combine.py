...
if __name__ == "__main__":
    ...
    stone_list = [(10,10),(20,20),
    (11,10),(21,20),
    (12,10),(22,20),
    (13,10),(23,20),
                  ]
    
    # stone_list = [(1*30//4, GRID_SIZE*i) for i in range(5)]
    stone_list = [(10, i) for i in range(15)]
    start_position = (0, 0)
    ...
    for episode in range(episodes):
        ...
        if (episode % 100 == 0):
            ...
            # print(C)
            # print("-----------------------")
            area = 1#get_area(area, success_episode, C)
        ...
        while True:
            ...
            # print("TAKES: ",stop_time - start_time)
    ...
    observation, reward, done = vehicle.get_state(obstacles, (3,3), area)
    running = True
    while running:
        ...
        a_index = policy[observation[0]//GRID_SIZE][observation[1]//GRID_SIZE]
        # next_state = action_result(action[a_index], state, n-1)

        print("INDEX: ",a_index, "   ",action[a_index], "   STATE: ",vehicle.rect)
        ...
        new_observation, reward, done = vehicle.get_state(obstacles, observation, area)
        print("new_observation  :  ", new_observation)
        # Render Game
        screen.fill(WHITE)
        vehicle.draw_fov(screen, grid)
